...
// router.get("/", getLogin);
router.route("/").post(upload.array("images"), userController_1.postUser).get(userController_1.getAllUsernames);
router.route("/login").post(userController_1.loginUser);
router.route("/:username").get(userController_1.getUserProfile);
router.route("/username/:id").get(userController_1.getUsername);
